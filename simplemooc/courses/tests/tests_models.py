...
class CourseManagerTestCase(TestCase):
	...
	def setUp(self):
		self.courses_django = mommy.make(		
			...
			_quantity=5	# '_quantity' é um parâmetro de quantidade, ao invés de repetir a mesma linha, para criar vários, é só usar o '_quantity=qtd'. Quando faz o '_quantity' desses, ele vai retornar não um 'model', e sim uma 'queryset', a lista lá de 'models'.
		)
